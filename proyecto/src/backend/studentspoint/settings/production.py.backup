...
MIDDLEWARE = [
    ...
    'studentspoint.middleware.CustomCorsMiddleware',
]
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para el sistema de gestión estudiantil StudentsPoint',
    'VERSION': '1.2.0',
...
# HTTPS settings (habilitar solo si tienes SSL)
